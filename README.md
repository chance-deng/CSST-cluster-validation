...
[`Example/`](Example/) contains a COSMOS-Web DR1 run over $0.01\le z\le 3.7$, together with its config, candidate table, raw peaks, slice stats, merge assignments, and summary JSON. 
